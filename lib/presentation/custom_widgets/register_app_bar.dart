  ...
  Widget _getBackButton({required BuildContext context}) {
    return showBackButton == true
        ? ElevatedButton.icon(
            ...
            label: Text("", style: Theme.of(context).textTheme.bodySmall?.copyWith(fontSize: 12)),
            style: ElevatedButton.styleFrom(elevation: kDimens0, backgroundColor: Colors.transparent))
        : const SizedBox();
  }
}
